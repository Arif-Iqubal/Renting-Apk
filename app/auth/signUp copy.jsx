              ...
              <View style={styles.userpasbox}>
                <View style={styles.username}>
                  ...
                  <TextInput
                    ...
                    // onChangeText={(value) => {
                    //   setName(value);  
                    //   handleChange('name', value);  // Formik state update
                    // }}
                    value={values.name} 
                ...
                <View style={styles.username}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(value) => {
                      setEmail(value);  
                      handleChange('email');  // Formik state update
                    }}
                    value={values.email} 
                ...
                <View style={styles.password}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(value) => {
                      setPassword(value);  // Update local state
                      handleChange('password');  // Call Formik's handleChange correctly
                    }}
